/*! p5.sound.min.js v0.3.0 2016-04-07 */
...
! function(t, e) {
    ...
    master = function() {
        ...
        var t = function() {
            ...
            this.input = t.createGain(), this.output = t.createGain(), this.limiter = t.createDynamicsCompressor(), this.limiter.threshold.value = 0, this.limiter.ratio.value = 100, this.audiocontext = t, this.output.disconnect(), this.inputSources = [], this.input.connect(this.limiter), this.limiter.connect(this.output), this.meter = t.createGain(), this.fftMeter = t.createGain(), this.output.connect(this.meter), this.output.connect(this.fftMeter), this.output.connect(this.audiocontext.destination), this.soundArray = [], this.parts = [], this.extensions = []
        }, e = new t;
        ...
        }, p5.soundOut = e, p5.soundOut._silentNode = e.audiocontext.createGain(), p5.soundOut._silentNode.gain.value = 0, p5.soundOut._silentNode.connect(e.audiocontext.destination), e
    }(sndcore);
    var helpers;
    helpers = function() {
        "use strict";
    ...
    soundfile = function() {
        ...
        function t(t, e) {
            for (var i = {}, o = t.length, n = 0; o > n; n++) {
                if (t[n] > e) {
                    var r = t[n],
                        s = new c(r, n);
                    i[n] = s, n += 6e3
            ...
            return t.forEach(function(t, o) {
                try {
                    ...
                    var s = i.some(function(e) {
                        return e.tempo === r ? e.count += t.count : void 0
                    });
                    if (!s) {
                        if (isNaN(r)) return;
                        i.push({
        ...
        p5.SoundFile = function(t, e, i, o) {
            ...
            var r, a, u = this,
                ...
                t = t || 0;
            if (0 > t && (t = 0), t += c, !this.buffer) throw "not ready to play file, buffer has yet to load. Try preload()";
            ...
            if (this.bufferSourceNode = this._initSourceNode(), this._counterNode && (this._counterNode = void 0), this._counterNode = this._initCounterNode(), o) {
            ...
            if (this.playbackRate !== t || !this.bufferSourceNode || this.bufferSourceNode.playbackRate.value !== t) {
                ...
                if (0 === this.playbackRate && this._playing && this.pause(), this.playbackRate < 0 && !this.reversed) {
                    ...
                    this.pauseTime = o
                } else this.playbackRate > 0 && this.reversed && this.reverseBuffer(); if (this.bufferSourceNode) {
            ...
            if (t || (t = 5 * window.width), this.buffer) {
                for (var e = this.buffer, i = e.length / t, o = ~~ (i / 10) || 1, n = e.numberOfChannels, r = new Float32Array(Math.round(t)), s = 0; n > s; s++)
                    for (var a = e.getChannelData(s), u = 0; t > u; u++) {
                        for (var c = ~~ (u * i), p = ~~ (c + i), h = 0, l = c; p > l; l += o) {
                            var f = a[l];
                            f > h ? h = f : -f > h && (h = f)
            ...
            var t = this,
                e = a.currentTime,
                i = a.createBufferSource();
            return i.buffer = t.buffer, i.playbackRate.setValueAtTime(t.playbackRate, e), i
        };
        var u = function(t) {
        ...
        p5.SoundFile.prototype.processPeaks = function(n, r, s, a) {
            ...
            g.type = "lowpass", v.connect(g), g.connect(y.destination), v.start(0), y.startRendering(), y.oncomplete = function(r) {
                ...
                do p = t(a, f), f -= .005; while (Object.keys(p).length < m && f >= d);
                var u = e(p),
                    c = i(u, s.sampleRate),
        ...
        p5.SoundFile.prototype.addCue = function(t, e, i) {
            ...
            for (var e = t / this.buffer.sampleRate, i = this._cues.length, o = 0; i > o; o++) {
                var n = this._cues[o],
                    r = n.time,
                    s = n.val;
    ...
    amplitude = function() {
        ...
        p5.Amplitude = function(e) {
            ...
            for (var e = 0; e < t.inputBuffer.numberOfChannels; e++) {
                for (var i, o = t.inputBuffer.getChannelData(e), n = o.length, r = 0, s = 0, a = 0; n > a; a++) i = o[a], this.normalize ? (r += Math.max(Math.min(i / this.volMax, 1), -1), s += Math.max(Math.min(i / this.volMax, 1), -1) * Math.max(Math.min(i / this.volMax, 1), -1)) : (r += i, s += i * i);
                var u = r / n,
                    c = Math.sqrt(s / n);
        ...
        p5.FFT = function(e, i) {
            ...
            if (i) {
                if (e && i) {
                    ...
                    for (var r = Math.round(e / o * this.freqDomain.length), s = Math.round(i / o * this.freqDomain.length), a = 0, u = 0, c = r; s >= c; c++) a += this.freqDomain[c], u += 1;
                    var p = a / u;
                    return p
                }
    ...
    Tone_core_Tone = function() {
        ...
        o.prototype.set = function(e, i, n) {
            ...
            if (t(e.defaults) || (i = Object.keys(e.defaults)), !t(e._super))
                for (var o = this._collectDefaults(e._super), n = 0; n < o.length; n++) - 1 === i.indexOf(o[n]) && i.push(o[n]);
            return i
        ...
        function toNotationHelper(t, e, i, o) {
            for (var n = this.toSeconds(t), r = this.notationToSeconds(o[o.length - 1], e, i), s = "", a = 0; a < o.length; a++) {
                var u = this.notationToSeconds(o[a], e, i),
                    c = n / u,
                    p = 1e-6;
                if (p > 1 - c % 1 && (c += p), c = Math.floor(c), c > 0) {
                    if (s += 1 === c ? o[a] : c.toString() + "*" + o[a], n -= c * u, r > n) break;
                    s += " + "
                }
            }
            return "" === s && (s = "0"), s
    ...
    Tone_core_Timeline = function(t) {
        ...
        return t.Timeline = function() {
            ...
            } else this._timeline.push(t); if (this.length > this.memory) {
            ...
            for (var e = 0, i = this._timeline.length, o = i; o >= e && i > e;) {
            ...
            for (var o = e; i >= o; o++) t(this._timeline[o]);
            if (this._iterating = !1, this._toRemove.length > 0) {
                for (var n = 0; n < this._toRemove.length; n++) {
                    var r = this._timeline.indexOf(this._toRemove[n]); - 1 !== r && this._timeline.splice(r, 1)
                }
                this._toRemove = []
            }
    ...
    env = function() {
        ...
        r.setContext(t.audiocontext), p5.Env = function(e, i, o, r, s, a) {
            ...
            this.aTime = t, this.aLevel = e, this.dTime = i || 0, this.dLevel = o || 0, this.rTime = t4 || 0, this.rLevel = l4 || 0, this._setRampAD(t, i)
            ...
            for (var o = 1; o < this.mathOps.length; o++) mathOps[o].dispose()
        }
    ...
    pulse = function() {
        ...
        function t() {
            for (var t = e.audiocontext, i = t.createBuffer(1, 2048, t.sampleRate), o = i.getChannelData(0), n = 0; 2048 > n; n++) o[n] = 1;
    ...
    noise = function() {
        ...
        var t = master;
        p5.Noise = function(t) {
            p5.Oscillator.call(this), delete this.f, delete this.freq, delete this.oscillator, this.buffer = e
        }, p5.Noise.prototype = Object.create(p5.Oscillator.prototype);
        var e = function() {
            for (var e = 2 * t.audiocontext.sampleRate, i = t.audiocontext.createBuffer(1, e, t.audiocontext.sampleRate), o = i.getChannelData(0), n = 0; e > n; n++) o[n] = 2 * Math.random() - 1;
            ...
            o = function() {
                for (var e = 2 * t.audiocontext.sampleRate, i = t.audiocontext.createBuffer(1, e, t.audiocontext.sampleRate), o = i.getChannelData(0), n = 0, r = 0; e > r; r++) {
    ...
    filter = function() {
        ...
        p5.Filter = function(e) {
            ...
            var i = this,
                o = e || 0;
            return 0 >= t && (t = 1), "number" == typeof t ? (i.biquad.frequency.value = t, i.biquad.frequency.cancelScheduledValues(this.ac.currentTime + .01 + o), i.biquad.frequency.exponentialRampToValueAtTime(t, this.ac.currentTime + .02 + o)) : t && t.connect(this.biquad.frequency), i.biquad.frequency.value
    ...
    reverb = function() {
        ...
        p5.Reverb = function() {
            ...
            for (e = 0; o > e; e++) t = this.reverse ? o - e : e, s[e] = (2 * Math.random() - 1) * Math.pow(1 - t / o, n), a[e] = (2 * Math.random() - 1) * Math.pow(1 - t / o, n);
    ...
    Tone_core_Clock = function(t) {
        ...
        return t.Clock = function() {
            ...
            var o = this.now(),
                ...
                s = t.State.Stopped;
            if (r && (s = r.state, -1 === this._nextTick && s === t.State.Started && (this._nextTick = r.time, this.isUndef(r.offset) || (this.ticks = r.offset))), s === t.State.Started)
    ...
    looper = function() {
        ...
        p5.prototype.setBPM = function(t, o) {
            ...
            for (var e in this.phrases) this.phrases[e].name === t && this.phrases.split(e, 1)
    ...
    soundRecorder = function() {
        ...
        function t(t, e) {
            for (var i = t.length + e.length, o = new Float32Array(i), n = 0, r = 0; i > r;) o[r++] = t[n], o[r++] = e[n], n++;
            return o
        }

        function e(t, e, i) {
            for (var o = i.length, n = 0; o > n; n++) t.setUint8(e + n, i.charCodeAt(n))
        }
        var i = master,
            o = i.audiocontext;
        p5.SoundRecorder = function() {
            ...
            for (var e = new Float32Array(this.recordedSamples), i = 0, o = t.length, n = 0; o > n; n++) {
                var r = t[n];
            ...
            var s = t(n, r),
                ...
                u = new DataView(a);
            e(u, 0, "RIFF"), u.setUint32(4, 44 + 2 * s.length, !0), e(u, 8, "WAVE"), e(u, 12, "fmt "), u.setUint32(16, 16, !0), u.setUint16(20, 1, !0), u.setUint16(22, 2, !0), u.setUint32(24, 44100, !0), u.setUint32(28, 176400, !0), u.setUint16(32, 4, !0), u.setUint16(34, 16, !0), e(u, 36, "data"), u.setUint32(40, 2 * s.length, !0);
